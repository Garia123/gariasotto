...
namespace WeTravel.DataAccess.Migrations
{
    ...
    [Migration("20201119042230_ImageAndReserves")]
    partial class ImageAndReserves
    {
            ...
            modelBuilder.Entity("WeTravel.Domain.Reserve", b =>
                {
                    ...
                    b.HasOne("WeTravel.Domain.Review", "Review")
                        .WithOne("Reserve")
                        .HasForeignKey("WeTravel.Domain.Reserve", "ReviewId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
